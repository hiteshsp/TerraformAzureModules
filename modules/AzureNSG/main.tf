...
resource "azurerm_network_security_rule" "az_network_security_rules" {
  ...
  destination_address_prefix                 = lookup(var.nsg_rules[count.index], "destination_address_prefixes", null) == null ? lookup(var.nsg_rules[count.index], "destination_address_prefix", "*") : null
